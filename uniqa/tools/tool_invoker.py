...
from uniqa.components.agents.state import State
# from uniqa.core.component.sockets import Sockets
from uniqa.dataclasses import ChatMessage, ToolCall
# from uniqa.dataclasses.streaming_chunk import StreamingCallbackT, StreamingChunk, select_streaming_callback
...
# from uniqa.tracing.utils import _serializable_value
...
class ToolInvoker:
    ...
    def __init__(
        ...
        *,
        ...
        :param async_executor:
            ...
            Note: As of uniqa 2.15.0, you no longer need to explicitly pass
            ...
            Support for `async_executor` will be removed in uniqa 2.16.0.
    ...
    def _default_output_to_string_handler(self, result: Any) -> str:
        ...
        # - If using convert_result_to_json_string we'd rather convert uniqa objects to JSON serializable dicts
        # - If using default str() we prefer converting uniqa objects to dicts rather than relying on the
        #   __repr__ method
    ...
    def _get_func_params(self, tool: Tool) -> Set:
        ...
        # if isinstance(tool, ComponentTool):
            # mypy doesn't know that ComponentMeta always adds __uniqa_input__ to Component
            assert hasattr(tool._component, "__uniqa_input__") and isinstance(
                tool._component.__uniqa_input__, Sockets
            )
            func_params = set(tool._component.__uniqa_input__._sockets_dict.keys())
        else:
    ...
    def run(
        ...
        *,
        ...
        tool_call_params, error_messages = self._prepare_tool_call_params(
            messages_with_tool_calls, state, resolved_enable_streaming_passthrough
        )
