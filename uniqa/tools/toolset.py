...
from uniqa.core.serialization import generate_qualified_class_name, import_class_by_name
from uniqa.tools.tool import Tool, _check_duplicate_tool_names
...
class Toolset:
    ...
    1. Group related tools together:
       ...
       to manage and use them as a unit in uniqa pipelines.

       Example:
       ```python
       from uniqa.tools import Tool, Toolset
       from uniqa.components.tools import ToolInvoker
    ...
    2. Base class for dynamic tool loading:
       ...
       Example:
       ```python
       from uniqa.core.serialization import generate_qualified_class_name
       from uniqa.tools import Tool, Toolset
       from uniqa.components.tools import ToolInvoker
    ...
    iterable tools, such as ToolInvoker or uniqa chat generators.
