...
# from uniqa.components.generators.chat.openai import OpenAIChatGenerator
# from uniqa.components.generators.chat.types import ChatGenerator
# from uniqa.core.component import component
from uniqa.core.serialization import component_to_dict
from uniqa.dataclasses.chat_message import ChatMessage
# from uniqa.utils.deserialization import deserialize_chatgenerator_inplace
...
class QueryExpander:
    ...
    ```python
    from uniqa.components.generators.chat.openai import OpenAIChatGenerator
    from uniqa_experimental.components.query import QueryExpander
    ...
    def __init__(
        ...
        *,
        ...
        :param prompt_template: Custom [PromptBuilder](https://docs.uniqa.deepset.ai/docs/promptbuilder)
