...
# from uniqa.utils import _deserialize_value_with_schema, _serialize_value_with_schema
# from uniqa.utils.callable_serialization import deserialize_callable, serialize_callable
# from uniqa.utils.type_serialization import deserialize_type, serialize_type
    ...
    def __init__(self, schema: Dict[str, Any], data: Optional[Dict[str, Any]] = None):
        ...
        :param schema: Dictionary mapping parameter names to their type and handler configs.
            ...
            If handler is None, the default handler for the type will be used. The default handlers are:
                - For list types: `uniqa.agents.state.state_utils.merge_lists`
                - For all other types: `uniqa.agents.state.state_utils.replace_values`
