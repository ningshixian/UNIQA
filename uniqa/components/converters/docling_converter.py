# Docling是一个功能强大的文档解析和转换工具，能够将PDF, DOCX, PPTX, XLSX, Images, HTML, AsciiDoc 和Markdown文档转换为HTML、Markdown 和JSON格式
# https://github.com/docling-project/docling-haystack/blob/main/docling_haystack/converter.py
