...
class OpenAIChatGenerator:
    ...
    from OpenAI API. It uses [ChatMessage](https://docs.uniqa.deepset.ai/docs/chatmessage)
    ...
    def __init__(  # pylint: disable=too-many-positional-arguments
        ...
        :param streaming_callback: A callback function that is called when a new token is received from the stream.
            The callback function accepts [StreamingChunk](https://docs.uniqa.deepset.ai/docs/data-classes#streamingchunk)
            as an argument.
        ...
        *,
        ...
        if streaming_callback is not None:
            completions = self._handle_stream_response(
                ...
                # and return a different type. See https://github.com/deepset-ai/uniqa/issues/9014.
        ...
        *,
        ...
        if streaming_callback is not None:
            completions = await self._handle_async_stream_response(
                ...
                # AsyncStream and return a different type. See https://github.com/deepset-ai/uniqa/issues/9014.
                chat_completion,  # type: ignore
                streaming_callback,
            )
