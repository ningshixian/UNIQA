# 1、提供组件（Component）的序列化和反序列化功能，
# 2、支持将对象转换为字典格式以便存储或传输，并能从字典恢复为对象实例
...
# from uniqa.core.component.component import _hook_component_init
from uniqa.core.errors import DeserializationError, SerializationError
# from uniqa.utils.type_serialization import thread_safe_import
