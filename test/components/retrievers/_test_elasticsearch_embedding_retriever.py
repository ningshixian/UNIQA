...
from uniqa.components.retrievers.elasticsearch import ElasticsearchEmbeddingRetriever
from uniqa.document_stores.elasticsearch import ElasticsearchDocumentStore
...
@patch("uniqa.document_stores.elasticsearch.document_store.Elasticsearch")
def test_to_dict(_mock_elasticsearch_client):
    document_store = ElasticsearchDocumentStore(hosts="some fake host")
    retriever = ElasticsearchEmbeddingRetriever(document_store=document_store)
    res = retriever.to_dict()
    t = "uniqa.components.retrievers.elasticsearch.embedding_retriever.ElasticsearchEmbeddingRetriever"
    assert res == {
        "type": t,
        "init_parameters": {
            "document_store": {
                ...
                "type": "uniqa.document_stores.elasticsearch.document_store.ElasticsearchDocumentStore",
            },
            "filters": {},
            "top_k": 10,
