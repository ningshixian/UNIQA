...
from uniqa.dataclasses.answer import Answer, ExtractedAnswer, GeneratedAnswer
from uniqa.dataclasses import Document, ChatMessage

"""pytest -svx test/dataclasses/test_answer.py"""
...
class TestExtractedAnswer:
    ...
    def test_to_dict(self):
        ...
        assert answer.to_dict() == {
            "type": "uniqa.dataclasses.answer.ExtractedAnswer",
            "init_parameters": {
                "data": "42",
                "query": "What is the answer?",
...
class TestGeneratedAnswer:
    ...
    def test_to_dict(self):
        ...
        assert answer.to_dict() == {
            "type": "uniqa.dataclasses.answer.GeneratedAnswer",
