...
import numpy as np
import pytest
from uniqa import Document, default_to_dict
...
from uniqa.components.retrievers.milvus import (
    MilvusEmbeddingRetriever,
    MilvusHybridRetriever,
    MilvusSparseEmbeddingRetriever,
)

""" pytest -svx test/compenents/retrievers/test_milvus_embedding_retriever.py """
...
class TestMilvusBuiltInFunction:
    ...
    def document_store(self) -> MilvusDocumentStore:
        document_store = MilvusDocumentStore(
            ...
            # },
            sparse_index_params={
                "index_type": "SPARSE_INVERTED_INDEX",  # "AUTOINDEX", "SPARSE_INVERTED_INDEX", "SPARSE_WAND", 
                "metric_type": "BM25",
            },
            builtin_function=[
                BM25BuiltInFunction(
