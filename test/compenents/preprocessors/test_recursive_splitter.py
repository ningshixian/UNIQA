...
from uniqa.components.preprocessors.recursive_splitter import RecursiveDocumentSplitter
# from uniqa.components.preprocessors.sentence_tokenizer import SentenceSplitter
...
chunker = RecursiveDocumentSplitter(split_length=20, split_overlap=0, separators=["\n\n", "sentence"])
chunker.warm_up()
